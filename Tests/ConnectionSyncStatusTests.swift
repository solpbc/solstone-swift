...
nonisolated final class ConnectionSyncStatusTests: XCTestCase {
    ...
    func testOmiWatchAndImportAggregationCanDriveTransferring() {
        let confirmedCount = confirmedTransferCount(observer: 0, omi: 1, watch: 2, importQueue: 3)
        ...
        let recentBytes = recentBytesTotal(observer: 0, omi: 64, watch: 128, importQueue: 256)
