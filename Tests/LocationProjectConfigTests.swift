...
nonisolated final class LocationProjectConfigTests: XCTestCase {
    func testProjectYMLIncludesLocationUsageStringsAndBackgroundMode() throws {
        ...
        XCTAssertTrue(projectYML.contains(#"INFOPLIST_KEY_NSMicrophoneUsageDescription: "sol hears what you hear — the meetings and voice memos you start — and keeps them on this phone, yours alone, until you connect a journal. nothing is shared with sol pbc.""#))
        XCTAssertTrue(projectYML.contains(#"INFOPLIST_KEY_NSLocationWhenInUseUsageDescription: "sol adds where your day happens and keeps it on this phone — yours alone, until you connect a journal. you choose how much; you can change it or delete it any time.""#))
        XCTAssertTrue(projectYML.contains(#"INFOPLIST_KEY_NSLocationAlwaysAndWhenInUseUsageDescription: "sol adds where your day happens, even in the background, and keeps it on this phone — yours alone, until you connect a journal. you choose how much; you can change it or delete it any time.""#))
