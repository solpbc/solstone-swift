...
nonisolated final class PairClientTests: XCTestCase {
    ...
    func testLANPairPostNoLongerUsesURLSessionOrHTTPSRequestBuilder() throws {
        ...
        let postLAN = try Self.slice(text, from: "private func postLAN", to: "private func postRelay")
        XCTAssertFalse(postLAN.contains("URLSession"))
        XCTAssertFalse(postLAN.contains("data(for:"))
    }
