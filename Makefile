...
BRAND_SVGS = Sources/Assets.xcassets/SolWordmark.imageset/sol-wordmark.svg:mark \
	...
	Sources/Assets.xcassets/LaunchMark.imageset/launch-mark.svg:mark \
...
# disposable-simulator captures; release startup behavior is unchanged.
launch-shots: sim
	python3 test/capture_launch_screen.py --derived "$(DERIVED)" \
		--output "$(if $(LAUNCH_SHOTS_OUT),$(LAUNCH_SHOTS_OUT),build/launch-screen-shots)"
