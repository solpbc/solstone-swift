...
### Fixed
- if the app could not finish checking your journal mark in time while connecting, it no longer completes pairing silently. it now lets you choose whether to continue or cancel.
