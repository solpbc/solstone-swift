...
nonisolated enum SourceVocabulary {
    ...
    static let watchNoticeAudioCouldNotStartBody = "open sol on your watch to start again."
    static let watchNoticeAudioStoppedTitle = "audio stopped itself"
    static let watchNoticeAudioStoppedBody = "open sol on your watch to start again."
    static let watchNoticeAudioCouldNotBeSavedTitle = "audio could not be saved"
    static let watchNoticeAudioCouldNotBeSavedBody = "open sol on your watch before your next moment."
    static let watchNoticeAudioCouldNotBeConfirmedTitle = "audio could not be confirmed"
    static let watchNoticeAudioCouldNotBeConfirmedBody = "open sol on your watch to check audio."
    static let watchWristAlertWillTap = "sol will tap your wrist if audio needs attention"
