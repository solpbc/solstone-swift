...
nonisolated enum SourceVocabulary {
    ...
    static let screencastSystemEndedSubtext = "screen sharing ended"
    ...
    static let watchHeadlineStopping = "stopping"
    ...
    static let watchPipelineAbandoned = "never reached your iphone"
    static let watchPipelineAbandonedSubtext = "the audio was deleted from your watch"
    static let watchPipelineHandedOff = "handed to your iphone"
    static let watchPipelineRelayStuckReason = "your watch has segments saved, but this device has not received anything for a while."
    static let watchPipelineHandoffStuckReason = "segments are on this device and waiting to reach your journal."
    ...
    static let watchPipelineKnownGroupLabel = "known on this device"
    static let watchStuckNoticeTitle = "sync needs attention"
    static let watchPipelineRelayStuckNextStep = "keep your watch near this device. open the solstone app on your watch if this does not move."
    static let watchPipelineHandoffStuckNextStep = "keep the solstone app open here while your journal catches up."
    static let watchPipelineOrphanStuckNextStep = "open the solstone app on your watch and keep it near this device so they can come over again."
    ...
    static let watchNoWatchPairedSubtext = "no watch paired with this device."
    ...
    static let watchSteadyPhoneSyncingHeadline = "on this device"
    ...
    static let watchSetupValueLine = "the solstone app on your watch takes in what you share from your wrist, hands it to this device, and it all syncs into your journal."
    static let watchSetupNoWatchBody = "pair an apple watch to this device and the solstone app can come along on your wrist. everything else in solstone works without one."
    ...
    static let watchSetupOpenSubline = "the solstone app checks in with this device the first time it opens."
    ...
    static let watchPairedWithPhoneLabel = "paired with this device"
    ...
    static let watchDiagnosticsOmittedObservationsLabel = "omitted rows"
    ...
    static func watchAbandonedCount(_ n: Int) -> String {
        "\(n) \(Self.watchPipelineAbandoned)"
    }
    ...
    static let journalMarkCouldNotVerifyTitle = "couldn't verify"
    static let journalMarkCouldNotVerifyBody = "we couldn't finish checking the journal mark. that doesn't mean the marks disagree — we just couldn't complete verification."
