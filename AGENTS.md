...
- `solpbc/spl-swift` (product `SPLTunnel`) — SPL tunnel package pinned at `exactVersion: 0.8.0`; provides pairing, relay, inner mTLS, mux, and loopback transport.
